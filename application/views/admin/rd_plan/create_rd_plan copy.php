...
<head>
    ...
    <title><?php echo $this->session->userdata('company_name') ?> | Create RD Plan</title>
    ...
    <div class="wrapper">
        ...
        <div class="content-wrapper">
            ...
            <section class="content">
                <div class="container-fluid">
                    <a href="javascript:void(0);" data-toggle="modal" data-target="#add_sector_modal" title='Click Add Income Source' class="btn btn-primary float-right"> <i class="fas fa-plus"></i> Create Rd Plan</a><br><br>
                    <table id="example1" class="table table-bordered table-striped">
                        ...
                        <tbody>
                            <?php foreach($plan as $pl => $pln) { ?>
                                <tr>
                                    <td><?php echo $pl +1 ?></td>
                                    <td><?php echo $pln['plan_name'] ?></td>
                                    <td><?php if($pln['interval'] == 1) { echo $pln['duration']. "&emsp;Month"; }elseif($pln['interval'] == 2) { echo $pln['duration']."&emsp;Year";} ?></td>
                                    <td><?php echo $pln['amount'] ?></td>
                                    <td><?php echo $pln['interest_percent'] ?></td>
                                    <td>
                                        <a href="javascript:void(0);" data-toggle="modal" data-target="#update_rd_plan_modal" onclick="update_rd_plan(<?php echo $pln['id'] ?>)" title='Click to Update Register Data Details'><i class="fas fa-edit"></i></a>&emsp;
                                    </td>
                                </tr>
                            <?php } ?>
                        </tbody>
                            ...
                            <div class="row">
                                ...
                                <div class="col-12">
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <input type="text" name="interest_percent" id="interest_percent" class="form-control" placeholder="Enter Interest Percent">
                                    </div>
                                </div>
                                <div class="col-12">
                                    <label>Remark:</label>
