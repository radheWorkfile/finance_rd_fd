...
<body class="hold-transition sidebar-mini layout-fixed ">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="container">
                                                <div class="row" id="business_section" style="display:none;">
                                                    <div class="col-lg-6 col-md-6">
                                                        <div class="form-group">
                                                            <label class="lab">usiness Name <span class="text-danger">*</span></label>
    ...
    <script>
        ...
        $('#up_photo').submit(function(e) {
            e.preventDefault();
            $.ajax({
                url: '<?= base_url() ?>admin/Common/update_pic',
                type: "POST",
                data: new FormData(this),
                processData: false,
                contentType: false,
        ...
        function getPin(post) {
            $.ajax({
                url: '<?= base_url() ?>admin/Register/get_pin',
                type: "POST",
                data: {
                    'post': post
                },
        ...
        function getAssmMunc(dist) {
            $.ajax({
                url: '<?= base_url() ?>admin/Register/get_assembly',
                type: "POST",
                data: {
                    'dist': dist
                },
            ...
            $.ajax({
                url: '<?= base_url() ?>admin/Register/get_munci',
                type: "POST",
                data: {
                    'dist': dist
                },
        ...
        function getPollingNm(pollingno) {
            $.ajax({
                url: '<?= base_url() ?>admin/Register/get_polling_nm',
                type: "POST",
                data: {
                    'pollingno': pollingno
                },
        ...
        function getCoun(mus) {
            $.ajax({
                url: '<?= base_url() ?>admin/Register/get_coun',
                type: "POST",
                data: {
                    'mus': mus
                },
        ...
        function getWard(ward) {
            $.ajax({
                url: '<?= base_url() ?>admin/Register/get_ward',
                type: "POST",
                data: {
                    'ward': ward
                },
        ...
        function gethouseNo(house) {
            $.ajax({
                url: '<?= base_url() ?>admin/Register/get_house',
                type: "POST",
                data: {
                    'house': house
                },
        ...
        function getPollingNo(poll) {
            $.ajax({
                url: '<?= base_url() ?>admin/Register/get_polling_no',
                type: "POST",
                data: {
                    'poll': poll
                },
        ...
        function getblocks(dis) {
            $.ajax({
                url: '<?= base_url() ?>admin/Register/get_blocks',
                type: "POST",
                data: {
                    'dis': dis
                },
            ...
            $.ajax({
                url: '<?= base_url() ?>admin/Register/get_const',
                type: "POST",
                data: {
                    'dis': dis
                },
        ...
        function getPanchyat(cons) {
            $.ajax({
                url: '<?= base_url() ?>admin/Register/get_panchyat',
                type: "POST",
                data: {
                    'cons': cons
                },
        ...
        function getPollingName(panch) {
            $.ajax({
                url: '<?= base_url() ?>admin/Register/get_polling',
                type: "POST",
                data: {
                    'panch': panch
                },
        ...
        function getPollingNos(polling) {
            $.ajax({
                url: '<?= base_url() ?>admin/Register/get_polling_name',
                type: "POST",
                data: {
                    'polling': polling
                },
