    ...
    <div class="card-body " style="background-image: linear-gradient(rgba(255,255,255,.7), rgba(255,255,255,.7)), url('<?php echo  base_url($gcmp['watermark']) ?>'); background-size: 500px; background-repeat: no-repeat; background-position:100px 320px;">
        ...
        <table>
            ...
            <tr>
                ...
                <td class="tds"><span class="head">RD NUMBER</span> : <?php echo $priemi['rd_no'] ?></td>
            </tr>
            <tr>
                <td class="tds"><span class="head">RD Plan</span> : <?php echo $priemi['pln_nm'] ?></td>
                <td class="tds"><span class="head">RD Duration</span> : <?php if ($priemi['interval'] == 1) {
