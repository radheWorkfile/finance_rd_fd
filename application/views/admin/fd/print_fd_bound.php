    ...
    <div class="card-body "
        ...
        <table class="table" style="width:100%;">
            ...
            <tr>
                ...
                <td class="td">
                    <?php echo date('d-m-Y',strtotime($pribound['fd_date'])) ?>
                </td>
                <td class="td">
                    <?php
        ...
        <div class="row" style="margin-top:30px;">
            <p><span style="margin-left:30px; font-weight:600;">Branch Manager</span> <span style="margin-left:300px; font-weight:600;">Customer Sign</span></p>
        </div>
    </div>
<?php } ?>