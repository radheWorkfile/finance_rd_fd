...
<head>
    ...
    <title>
        <?php echo $this->session->userdata('company_name') ?> | Create FD Plan
    </title>
...
<body class="hold-transition sidebar-mini layout-fixed ">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="javascript:void(0);" data-toggle="modal"
                                            ...
                                            onclick="update_fd_plan(<?php echo $pln['id'] ?>)"
            ...
            <div class="modal-dialog modal-md">
                <div class="modal-content">
                    <div class="modal-header">
                        <h4 class="modal-title">Create New FD Plan</h4>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
                    <form id="fd_plan_data" method="post" accept-charset="utf-8" enctype="multipart/form-data">
                        <div class="card-body">
                            <div class="col-12">
    ...
    <script>
        ...
        $('#fd_plan_data').submit(function (e) {
            e.preventDefault();
            $.ajax({
                url: '<?= base_url() ?>admin/Category/add_fd_plan',
                type: "POST",
        ...
        function update_fd_plan(id) {
            $.ajax({
                url: '<?= base_url() ?>' + 'admin/Category/update_fd_plan',
                type: "POST",
                data: {
                    'id': id
                },
                success: function (data) {
                    $('#up_fd_plan').html(data);
                },
            });
        }
        ...
        $('#rd_plan_updata').submit(function (e) {
            e.preventDefault();
            $.ajax({
                url: '<?= base_url() ?>admin/Category/update_fd_plan_data',
                type: "POST",
                data: new FormData(this),
                processData: false,
                contentType: false,
